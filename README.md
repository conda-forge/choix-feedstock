...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/choix-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12445&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/choix-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `choix` can be installed with:

```
conda install choix
```

It is possible to list all of the versions of `choix` available on your platform with:
